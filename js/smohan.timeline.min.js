...
+(function(){
    ...
    TP.render = function () {
        var me = this, container = me.container, o = me.config,
            sizes = me.sizes, i = 0,
        ...
        for( i ; i < sizes; i++){
            var item = me.items[i], point = $('.point',0,item),corner = $('.corner',0,item);
            ...
            if(isMinScreen && o.resize){ //全屏模式，一列，不显示point,line,corner
                ...
                var pointWidth = point.offsetWidth || 0, pointLeft = 0;
                if(i < 2){
                    heightArr[i] = height;  top = 0;
        ...
        line.style.cssText += 'position:absolute;left:50%;margin-left:-'+lineWidth/2+'px;height:100%;'
    };
